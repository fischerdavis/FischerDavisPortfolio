...
const About = () => {
  ...
  const linkedinLink = "https://linkedin.com/in/fischerdavis/";
  const githubLink = "https://github.com/fischerdavis";
  const newTab = "_blank";
    ...
    <div className="about-container" id="about">
      <div className="about-info-container">
        ...
        <div className="links-info">
          ...
          <a href={linkedinLink} target={newTab}>
          ...
          <a href={githubLink} target={newTab}>
            <svg className="about-icon" viewBox="0 0 128 128">
              <g fill="#E8EEF1">
